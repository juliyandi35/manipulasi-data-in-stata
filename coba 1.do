. generate bscrepetitiontfnum = real(bscrepetitiontf)
. generate bscrepetitiontfidfnum = real(bscrepetitiontfidf)
. generate bscrepetitiontf_stopnum = real(bscrepetitiontf_stop)

. generate bscrepetitiontfidf_stopnum = real(bscrepetitiontfidf_stop)


. gen invl5minnum = real(invl5min)

. gen invlstarttsnum = real(invlstartts)

. gen invlendtsnum = real(invlendts)

. gen storesessidnum = real(storesessid)
...
. gen bscRepetition = bscrepetitiontfidf_stopnum
